...
- `Fix` 일괄 실행 디바이스 패턴一括 / 브라우저 패턴에 일본어가 포함되어있으면, SauceLabs 모바일 실제 기기 테스트가 에러가 발생하여 수정했습니다.
...
- 테스트/프로젝트의 삭제 처리가 오랜시간 소요되는 것을 수정했습니다.プロジェクトの削除処理が遅くなっていたので修正しました。
...
- [magic-pod-api-client]로부터 복수의 디바이스 패턴을 사용한 일괄 실행이 가능합니다.
  - [magic-pod-api-client]의 [バージョン0.45.0.1]을 설치해야 합니다.
